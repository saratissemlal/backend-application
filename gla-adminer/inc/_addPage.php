<div class="links box">
    <h1 class="mb20">Ajouter une page</h1>
    ...
    <form action="" method="POST">
        <div class="left">
            ...
            <div class="mb10">
                <label>Titre</label>
                <input type="text" name="ptitle" placeholder="Titre de la page" spellcheck="true" />
            </div>

            <div class="mb10">
                <label>Contenu</label>
                <textarea name="pcontent" placeholder="Contenu de la page" id="content"></textarea>
            </div>
        ...
        <div class="right">
            ...
            <div class="mb10">
                ...
                <input type="text" name="ptitlear" placeholder="Titre de la page en arabe" spellcheck="true" />
            </div>

            <div class="mb10">
                <label>Contenu ARABE</label>
                <textarea name="pcontentar" placeholder="Contenu de la page en arabe" id="content_ar"></textarea>
            </div>
